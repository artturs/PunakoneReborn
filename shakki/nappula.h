...
public:
	...
	// omalla tavallaan.
	virtual void annaSiirrot(concurrency::concurrent_vector<Siirto>& lista, Ruutu*, Asema*, int vari) = 0;

	int siirtoLoop(concurrency::concurrent_vector<Siirto>& lista, Ruutu* ruutu, Asema* asema, int paikkaX, int paikkaY, int suuntaX, int suuntaY, int nappulanVari)
	{
...
public:
	...
	void annaSiirrot(concurrency::concurrent_vector<Siirto>& lista, Ruutu*, Asema*, int vari);
};
...
public:
	...
	void annaSiirrot(concurrency::concurrent_vector<Siirto>& lista, Ruutu*, Asema*, int vari);
private:
	void lisaaSotilaanKorotukset(Siirto*, concurrency::concurrent_vector<Siirto>& lista, Asema*);
};
